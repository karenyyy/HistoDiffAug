...
"""
Mostly borrowed from DINO and timm library:
...
def _no_grad_trunc_normal_(tensor, mean, std, a, b):
    # Borrowed from PyTorch official master
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, return_all_tokens=None, mask=None):
        ...
        if return_all_tokens:
            return x
        return self.forward_image_head(x[:, 0])
    ...
    def mask_model(self, x, mask):
        ...
        x.permute(0, 2, 3, 1)[mask, :] = self.masked_embed.to(
            x.dtype)
        return x
